    ...
    <footer className="footer py-5 mt-5">
        <div className="container">
            ...
            <div className="row align-items-center">
                ...
                <div className="col-lg-4">
                <h5 className="sticky-top">Former iGEM Bielefeld teams</h5>
                </div>
            </div>
            <div className="row align-items-center">
                <div className="col-lg-4">
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-2">
                            <a type="button" className="btn btn-secondary"  href="https://www.linkedin.com/in/igem-bielefeld-cebitec">
                        ...
                        <div className="col-lg-2">
                            <a type="button" className="btn btn-secondary" href="https://www.instagram.com/igem.bielefeld/">
                        ...
                        <div className="col-lg-2">
                            <a type="button" className="btn btn-secondary" href="https://x.com/iGEM_Bielefeld">
                ...
                <div className="col-lg-4">
                    <div className="row align-items-center">
                        <div className="col">
                            <div className="col">
                                <a href="https://2024.igem.wiki/bielefeld-cebitec/"> Team 2024</a>
                            </div>
                            <div className="col">
                ...
                <div className="col">
                    ...
                    <p>
                        <small>
                            ...
                            <a href="https://github.com/LS22UB/igem-bielefeld-2024">
                                https://github.com/LS22UB/igem-bielefeld-2024
                            </a>
                            .
                        </small>
                    </p>
